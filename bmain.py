...
class Splash(Toplevel):
    def __init__(self, parent):
        ...
        self.logo = PhotoImage(file=f"{Utils.prgpath}/logo.gif") 
        self.geometry("700x700+0+0")
        self.config(bg="green")
        self.logo_label = Label(self,image=self.logo,bg='green')
        self.logo_label.pack()
        self.label_process = Label(self,text="Please Wait",font=('Comic Sans MS',15,'bold'),fg='white',bg='green')
        self.label_process.pack()
...
class Application(Tk, Sender):
    ...
    def about(self, event=None, timer=None):
        ...
        toplevel.title(_("เกี่ยวกับ {} v{}").format(Utils.__prg__, __version__))
